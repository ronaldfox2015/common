import { LoggerService } from '@common/application/service/logger.service'
import { INFO, WARNING, CRITICAL } from '@common/domain/enum/logger.const.util'
import { LogData } from '@common/domain/log-data.interface'
...
describe('LoggerService', () => {
  ...
  it('debería loguear un mensaje con nivel INFO', () => {
    service.log('test message', { clientIp: '127.0.0.1', startTime: Date.now() })
  ...
  it('debería loguear un mensaje con nivel WARNING', () => {
    service.warning('warning message', { status: 400, originalUrl: '/api/test' })
