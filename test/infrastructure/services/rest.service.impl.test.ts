import { RestServiceImpl } from '../../../src/infrastructure/services/rest.service.impl';
...
describe('RestServiceImpl', () => {
  ...
  beforeEach(() => {
    ...
    restService = new RestServiceImpl('https://api.example.com');
  });
  ...
  describe('constructor', () => {
    it('should create axios instance with default configuration', () => {
      new RestServiceImpl('https://api.example.com');
    ...
    it('should create axios instance with custom configuration', () => {
      ...
      new RestServiceImpl('https://api.example.com', customConfig);
  ...
  describe('get', () => {
    it('should make GET request and return data', async () => {
      ...
      const result = await restService.get<typeof responseData>('/users/1');
    ...
    it('should make GET request with query parameters', async () => {
      ...
      const result = await restService.get<typeof responseData>('/users', params);
  ...
  describe('post', () => {
    it('should make POST request and return data', async () => {
      ...
      const result = await restService.post<typeof responseData>('/users', requestData);
  ...
  describe('put', () => {
    it('should make PUT request and return data', async () => {
      ...
      const result = await restService.put<typeof responseData>('/users/1', requestData);
  ...
  describe('delete', () => {
    it('should make DELETE request and return data', async () => {
      ...
      const result = await restService.delete<typeof responseData>('/users/1');
  ...
  describe('integration', () => {
    it('should work with different response types', async () => {
      ...
      const stringResult = await restService.get<string>('/status');
      ...
      const numberResult = await restService.get<number>('/count');
      ...
      const booleanResult = await restService.get<boolean>('/active');
